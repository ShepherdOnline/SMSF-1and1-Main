<div id="new_event_form">
	...
	<form id="new_post" name="new_post" method="post" action="<?php the_permalink(); ?>">
		...
		<div class="input">
			<label for="event_contactperson_email_body"><?php _e('Contact E-mail','events-made-easy-frontend-submit'); ?></label><br />
		...
		<div class="input">
			<label for="location_address1"><?php _e('Address','events-made-easy-frontend-submit'); ?></label>
