...
The plugin will look for form template and style files in the following paths, in that priority:
   ...
   1. <upload dir>/events-made-easy-frontend-submit/
...
Well yes: the EMEFS::attribute can have a second argument, indicating the html5-type of your field of choice:
Example: <?php EMEFS::attribute('extra1','url'); ?>
The different types supported: text (default), tel, url and email
