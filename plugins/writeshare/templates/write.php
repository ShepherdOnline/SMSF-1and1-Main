				...
				<div class="taxonomies">
					...
					?>
							...
							<?php else: ?>
								...
								<p class="description">
									<?php if ( $taxonomy['limit'] == 1 ): ?>
										<?php echo esc_html( sprintf( __( 'Select a %s', WriteShare::$TEXTDOMAIN ), $taxonomy['singular'] ) ); ?><?php if ( empty( $taxonomy['access'] ) ) echo __( ' or enter a new one by typing it in and then hitting return on your keyboard.', WriteShare::$TEXTDOMAIN ); ?>
									<?php else: ?>
										<?php echo esc_html( sprintf( __( 'Select %s', WriteShare::$TEXTDOMAIN ), $taxonomy['plural'] ) ); ?><?php if ( empty( $taxonomy['access'] ) ) echo __( ' or enter a new one by typing it in and then hitting return on your keyboard.', WriteShare::$TEXTDOMAIN ); ?>
									<?php endif; ?>
								</p>
