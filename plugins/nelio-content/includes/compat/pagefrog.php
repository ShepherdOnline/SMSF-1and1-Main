...
function nc_compat_pagefrog_fix_issues_with_post_page() {
	...
	add_action( 'admin_enqueue_scripts', 'nc_compat_pagefrog_remove_jquery_ui_style', 999 );
...
/**
 * This function deregisters jQuery UI's CSS (enqueued by pagefrog). This style
 * is not used in the post screen by them, and including it breaks our plugin.
 *
 * @since 1.0.5
 */
function nc_compat_pagefrog_remove_jquery_ui_style() {

		wp_deregister_style( 'jquery_ui' );

}//end nc_compat_pagefrog_remove_jquery_ui_style()
