...
class Nelio_Content_Admin_Menus {
	...
	public function add_custom_pages() {
		...
		// TODO. Recover this page.
		//add_submenu_page( $this->menu_slug,
		//	_x( 'My Activity', 'text (menu)', 'nelio-content' ),
		//	_x( 'My Activity', 'text (menu)', 'nelio-content' ),
		//	'edit_posts',
		//	'nelio-content-activity',
		//	array( $this, 'print_activity_page' )
		//);
	...
	public function add_settings_page() {
		...
		if ( nc_is_subscribed_to( 'team-plan' ) ) {
			...
			} else if ( nc_is_current_user( 'author', 'exactly' ) ) {
		...
		} else if ( nc_is_current_user_the_manager() ) {
	...
	public function fix_separator_location( $menu_order ) {
		...
		foreach ( $menu_order as $item ) {
			...
			} else if ( ! in_array( $item, $nelio_menu_items, true ) ) {
